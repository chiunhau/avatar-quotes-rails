...
class EpisodesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create episode" do
    assert_difference('Episode.count') do
      post episodes_url, params: { episode: { book_id: @episode.book_id, name: @episode.name } }
    end
  ...
  test "should update episode" do
    patch episode_url(@episode), params: { episode: { book_id: @episode.book_id, name: @episode.name } }
